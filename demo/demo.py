...
main_map = Map()
main_map.set_tile((0, 0), Terrain(['wall_topleft'], passable=False))
main_map.set_tile((1, 0), Terrain(['wall_top', 'window',], passable=False))
main_map.set_tile((2, 0), Terrain(['wall_top'], passable=False))
main_map.set_tile((3, 0), Terrain(['wall_top', 'window',], passable=False))
main_map.set_tile((4, 0), Terrain(['wall_topright'], passable=False))
main_map.set_tile((0, 1), Terrain(['wall_left'], passable=False))
main_map.set_tile((1, 1), Terrain(['floor_topleft', 'chair',], passable=False))
main_map.set_tile((2, 1), Terrain(['floor_top', 'table',], passable=False))
main_map.set_tile((3, 1), Terrain(['floor_topright', 'shelf',], passable=False))
main_map.set_tile((4, 1), Terrain(['wall_right'], passable=False))
main_map.set_tile((0, 2), Terrain(['wall_left'], passable=False))
...
main_map.set_tile((4, 2), Terrain(['wall_right'], passable=False))
main_map.set_tile((0, 3), Terrain(['wall_left'], passable=False))
main_map.set_tile((1, 3), Terrain(['floor_bottomleft', 'bed',], passable=False))
...
main_map.set_tile((4, 3), Terrain(['wall_right'], passable=False))
