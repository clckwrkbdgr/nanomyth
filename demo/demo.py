...
fixed_font = nanomyth.view.sdl.font.FixedWidthFont(grey_font_image, '~1234567890-+!@#$%^&*()_={}[]|\\:;"\'<,>.?/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz' + '\x7f'*(3+5*12+7) + ' ')
...
font = nanomyth.view.sdl.font.ProportionalFont(white_font_image, '~1234567890-+!@#$%^&*()_={}[]|\\:;"\'<,>.?/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz' + '\x7f'*(3+5*12+7) + ' ', space_width=3, transparent_color=255)
...
main_menu.add_widget(nanomyth.view.sdl.widget.TextLineWidget(font, (80, 10), '<SPACE> to play.'))
